#ifndef  _NGX_HTTP_TEST_STATUS_MODULE_H
#define _NGX_HTTP_TEST_STATUS_MODULE_H


#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_MAIN                      \
...
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_SERVER_S                  \
...
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_SERVER                    \
...
/* #if (NGX_HTTP_CACHE)
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_SERVER_CACHE_S            \
    "# HELP nginx_vts_server_cache_total The requests cache counter\n"         \
    "# TYPE nginx_vts_server_cache_total counter\n"
 
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_SERVER_CACHE              \
...
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_FILTER_S                  \
...
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_FILTER                    \
...
/* #if (NGX_HTTP_CACHE)
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_FILTER_CACHE_S            \
    "# HELP nginx_vts_filter_cache_total The requests cache counter\n"         \
    "# TYPE nginx_vts_filter_cache_total counter\n"
 
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_FILTER_CACHE              \
...
#define NGX_HTTP_TEST_TRAFFIC_STATUS_PROMETHEUS_FMT_UPSTREAM                  \
...
u_char *ngx_http_test_traffic_status_display_prometheus_set_server_node(
    ngx_http_request_t *r,
    u_char *buf, ngx_str_t *key,
    ngx_http_test_traffic_status_node_t *vtsn);
u_char *ngx_http_test_traffic_status_display_prometheus_set_server(
    ngx_http_request_t *r, u_char *buf,
    ngx_rbtree_node_t *node);
u_char *ngx_http_test_traffic_status_display_prometheus_set_filter_node(
    ngx_http_request_t *r,
    u_char *buf, ngx_str_t *key,
    ngx_http_test_traffic_status_node_t *vtsn);
u_char *ngx_http_test_traffic_status_display_prometheus_set_filter(
    ngx_http_request_t *r, u_char *buf,
    ngx_rbtree_node_t *node);
u_char *ngx_http_test_traffic_status_display_prometheus_set_upstream_node(
    ngx_http_request_t *r,
    u_char *buf, ngx_str_t *key,
    ngx_http_test_traffic_status_node_t *vtsn);
u_char *ngx_http_test_traffic_status_display_prometheus_set_upstream(
    ngx_http_request_t *r, u_char *buf,
    ngx_rbtree_node_t *node);

u_char *ngx_http_test_traffic_status_display_prometheus_set(ngx_http_request_t *r,
    u_char *buf);

ngx_int_t ngx_http_test_traffic_status_escape_prometheus(ngx_pool_t *pool, ngx_str_t *buf, u_char *p, size_t n);
